...
本项目使用 `uv` 管理 Python 虚拟环境，虚拟环境位于 `backend/.venv/`。

运行脚本时使用虚拟环境中的 Python：

```bash
# Windows
D:\codespace\ChewyBBTalk\backend\.venv\Scripts\python.exe <script_path> <args>

# macOS/Linux
./backend/.venv/bin/python <script_path> <args>
```
